...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-16 06:04`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/36099cc2-7197-4d66-bfce-d405fe1efdec.git
$ cd 36099cc2-7197-4d66-bfce-d405fe1efdec
```
